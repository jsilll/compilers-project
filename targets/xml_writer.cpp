...
{
  std::cout << "void l22::xml_writer::do_sequence_node(cdk::sequence_node *const node, int lvl)" << std::endl;
...
{
  std::cout << "void l22::xml_writer::do_block_node(l22::block_node *node, int lvl)" << std::endl;
  openTag(node, lvl);
